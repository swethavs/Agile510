...
public class AboutAssertions {
    ...
    public void assertEqualsWithDescriptiveMessage() {
        ...
        String stringArg ="The answer to 'life the universe and everything' should be 42";
        assertEquals("The answer to 'life the universe and everything' should be 42", stringArg);
    }
