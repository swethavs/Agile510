...
public class AboutDates {
    ...
    public void dateToString() {
        assertEquals(date.toString(), new Date(100010001000L).toString());
    }
    ...
    public void changingDateValue() {
        ...
        assertEquals(date.toString(), new Date(100010001000L + oneHourInMiliseconds).toString());
    }
    ...
    public void usingCalendarToChangeDates() {
        ...
        assertEquals(cal.getTime().toString(), date.toString());
    }
    ...
    public void usingDateFormatToFormatDateFull() {
        ...
        assertEquals(formattedDate, "Tuesday, April 3, 1973");
    }
