...
public class AboutFileIO {
    ...
    public void basicFileWritingAndReading() throws IOException {
        ...
        assertEquals(new String(in).trim(),new String("First line\nSecond line                            ").trim());
        file.delete();
    }
    ...
    public void betterFileWritingAndReading() throws IOException {
        ...
        try {
            ...
            assertEquals(br.readLine(), new String("First line")); // first line
            assertEquals(br.readLine(), new String("Second line")); // second line
